...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© :current_year <a href="https://tasmemstudio.com" style="color:black;" target="_blank">TasmemStudio</a>. All rights reserved.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© :current_year <a href="https://tasmemstudio.com" style="color:black;" target="_blank">TasmemStudio</a>. All rights reserved.',
                'locale'                 => 'Locale',
